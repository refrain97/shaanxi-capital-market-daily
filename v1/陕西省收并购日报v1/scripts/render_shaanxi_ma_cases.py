...
cases = [
    ...
    ("06 西安旅游转让红土创新等参股股权", "已上市公司", "转让款到账完成", "red", "teal", "2026-03-06董事会；2026-05-26收款完成", "陕西上市公司出售参股股权｜关联股权转让", "西安红土创新50%、西旅创投30%；西旅集团实业", "合计1581.25万元；红土公司评估值2796.31万元", "文旅/创投平台", "退市风险压力下小额资产处置，改善流动性有限", "继续处置资产、定增输血进展、持续经营修复"),
    ...
    ("12 金利华电拟收购中科西光82.50%股权", "活跃非上市公司", "预案披露/复牌", "teal", "gold", "2026-05-20复牌；5月19日董事会通过预案", "外地上市公司收购西安商业航天标的｜发行股份及现金", "西安中科西光82.50%股权；金利华电", "作价待审计评估；同步募集配套资金", "商业航天/高光谱卫星/遥感数据", "玻璃绝缘子上市公司跨界进入卫星制造及遥感服务", "审计评估、交易作价、股东会、深交所审核和证监会注册"),
    ...
    ("15 紫光国芯完成15%股份协议转让", "拟上市与辅导企业", "过户完成", "gold", "teal", "2026-03-10协议；2026-05-11过户完成", "新三板半导体企业股份协议转让｜产业投资者入股", "西安紫光国芯；三家产业资本分别受让5%股份", "合计约6.75亿元；三方各受让681.6036万股", "半导体/存储芯片", "引入多地产业资本，紫光存储持股降至45.67%，控制权不变", "后续融资、IPO路径、产业资本协同"),
    ("16 美能能源拟收购上海立成90%股权", "已上市公司", "董事会通过", "red", "gold", "2026-05-21董事会；2026-05-22公告", "陕西上市公司收购储能资产｜募投变更暨关联交易", "上海美能立成；美能能源向美能投资收购", "7,395.78万元；其中拟投入募集资金6,951.00万元", "工商业用户侧储能/综合能源服务", "陕西燃气上市公司通过并购切入新型储能赛道，交易完成后上海立成纳入合并报表", "6月9日股东会、关联股东回避、募集资金监管协议补充、股权交割"),
    ("17 世纪金花出售西安亿鑫物业100%股权", "活跃非上市公司", "协议签署/待股东特别大会", "teal", "gold", "2026-05-21协议；2026-05-25公开报道复核", "港股上市公司出售西安商业物业平台股权及债权", "西安亿鑫物业管理；西安曲江金控资管", "约7.62亿元；含100%股权及相关债权", "商业物业/零售资产处置", "曲江体系内商业物业资产流转，补充西安消费商业资产交易样本", "股东特别大会批准、交割付款、债权转让安排、世纪金花现金流修复"),
]
...
def draw_case(x, y, c):
    rounded((x, y, x + 800, y + 530), 0, WHITE, CARD_BORDER, 1)
    ...
    for lab, val in labels:
        ...
        line_count = min(len(wrap_cn(val, F_BODY, value_w)), 3)
        paragraph(value_x, yy, val, F_BODY, value_color, value_w, 32, 3)
        yy += 40 if line_count <= 1 else 34 * line_count + 4
