...
const dailyImageArchive=(index,channel)=>{
  const rows=(index?.channels?.[channel]||[])
    .filter(row=>row?.publicPath&&row.webStatus==="published"&&row.origin==="v2")
...
function listed(data){
  ...
  const nav=[["business-focus","重点跟踪"],["section-01","01 机会"],["section-02","02 风险"],["section-03","03 动态"],["section-04","04 资本运作"],["section-05","05 治理披露"],["section-06","06 下一步"],["listed-pool","上市观察池"],["listed-daily-images","日图归档"]];
