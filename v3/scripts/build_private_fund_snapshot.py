...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--previous-date", default="2026-07-09")
...
def main() -> None:
    ...
    managers = current["raw"]["shaanxiOfficeManagers"]
    products = current["shaanxiOfficeProducts"]
    previous_products = previous["shaanxiOfficeProducts"]
    ...
    for rank, (score, score_evidence, manager) in enumerate(top, 1):
        ...
        enriched.update({"rank": rank, "activityScore": score, "scoreEvidence": score_evidence})
    ...
    snapshot = {
        ...
        "scope": "注册地或办公地在陕西省的私募证券投资基金管理人",
        "summary": {
            "managerCount": current["shaanxiOfficeManagerCount"],
