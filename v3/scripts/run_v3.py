...
def main() -> int:
    ...
    try:
        ...
        steps = [
            ...
            run_step("build_private_fund_snapshot", [python, "v3/scripts/build_private_fund_snapshot.py"]),
            run_step("backfill_private_fund", [python, "v3/scripts/backfill_private_fund_2026.py"]),
            run_step("backfill_ma_from_listed", [python, "v3/scripts/backfill_ma_from_listed.py"]),
            run_step("update_backfill_coverage", [python, "v3/scripts/update_backfill_coverage.py"]),
